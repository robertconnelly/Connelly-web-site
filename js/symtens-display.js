...
function ui_config_modal_close() {
  let _m = document.getElementById("configModal");
...
function init() {
  ...
  let cfg_btn = document.getElementById("ui_btn_modal_config");
  cfg_btn.addEventListener("click", function() {
    let _m = document.getElementById("configModal");
